"""
This is the utils method for git
"""
import logging
import subprocess
import os
...
# Because that is the name git gave it
# pylint: disable= unused-argument
# Because it will be used in some situations

git_logger = logging.getLogger(__name__)

def check_valid_path(func):
    """This checks if a path is valid"""
    @wraps(func)
...
def is_file_in_repo(path):
    """This checks if a file is in the repo"""
...
def has_diff_files(path):
    """
    This checks if the repo has diff files
...
def has_untracked_files(path):
    """
    This checks if the repo has untracked files
